...
.progressbar-container
    .progressbar-wrapper
        ...
        .progressbar
            ...
            //- Transit to TMR
            //- .progressbar--bar.green-light(
            //-     :style="{ width: TransitToTMRPercentage + '%' }",
            //-     v-if="TransitToTMRPercentage !== false"
            //- )
            //-     .progressbar--bar-value(
            //-         v-if="!(Number(TransitToTMRPercentage) <= 0)", 
            //-         :style="valueOffset(TransitToTMRPercentage)"
            //-     ) {{ TransitToTMRPercentage }}%
